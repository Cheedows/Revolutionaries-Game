...
const QUESTIONS := {
	...
	Intent.ASSIGN_ACTIVITY: "Taking Action: What will they do?",
	Intent.FORM_SQUAD: "Who is going?",
	Intent.EQUIP_SQUAD: "What are they taking?",
	Intent.CHOOSE_VEHICLE: "Choose a Liberal squad member to drive it.",
	Intent.CHOOSE_DESTINATION: "Where will the Squad go?",
	Intent.CHOOSE_CAR_TYPE: "What type of car will they take?",
	...
	Intent.CHOOSE_PURCHASE: "What will they buy?",
	Intent.CHOOSE_ITEMS_TO_FENCE: "What will you sell?",
