...
def main() -> int:
    ...
    # Size rule: no file over 300 lines (ARCHITECTURE.md §3). Two exemptions,
    # for the same reason — the length is content, not complexity. A generated
    # file is as long as the thing it was lifted from. A file under data/ is a
    # list, and data/ is already forbidden behaviour by the rule above, so
    # splitting a long one at an arbitrary entry helps nobody.
